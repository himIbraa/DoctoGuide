...
class buildCompletedConsultations extends StatefulWidget {
  final Patient patient;

  const buildCompletedConsultations({super.key, required this.patient});

  @override
  State<buildCompletedConsultations> createState() => _buildCompletedConsultationsState();
}

class _buildCompletedConsultationsState extends State<buildCompletedConsultations> {
  @override
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => DetailedCompletedConsultation(patient: widget.patient)),
              );
            },
            child: Column(
